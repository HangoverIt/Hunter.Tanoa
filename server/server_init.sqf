...
h_isMissionVehicle = compileFinal preprocessFileLineNumbers "functions\h_isMissionVehicle.sqf" ;
h_setMissionVehicle = compileFinal preprocessFileLineNumbers "functions\h_setMissionVehicle.sqf" ;
h_unsetMissionVehicle = compileFinal preprocessFileLineNumbers "functions\h_unsetMissionVehicle.sqf" ;
